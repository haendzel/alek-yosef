...
<title>Aleksander Jozefczyk - director and illustrator</title>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
<link rel="stylesheet" href="https://use.typekit.net/nsn6cfm.css">
...
<link rel="stylesheet" href="css/responsive.css">
  ...
  <body>
      ...
      <!---  PAGE CONTENT ---> 
      <div class="container col-lg-9 col-md-12 col-xs-12">
      <div class="title">About me<br><br></div>
      Hello, I'm Alek, Alek Jozefczyk and I live in Stanislawow Dolny, right next to Kalwaria Zebrzydowska. I get to Krakow via Skawina and Wola Justowska and then march along Queen Jadwiga street to Blonia and from there I get ride by Wavelo's bike to Karmelicka 13 to make animations and some special art.
      </div>
      </div>
